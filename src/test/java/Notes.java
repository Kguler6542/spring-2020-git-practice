...
to create local repository:
 git init
this command should be executed only once, to initialize git repository. Make sure that you run this command in the project folder.
...
*.iml
*.log
first 3 are must, we haven't met log files yet, I will shot you tomorrow what is that.
...
If git status, gives you error, you don't have git repo.
...
3. once you commit, updates are going too local repo
4. once you push, updates are going too github
    1.                  2.              3.              4.
